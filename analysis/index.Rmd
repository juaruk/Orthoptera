...
<span class="tab-container">
  <img src="assets/project2.png">
    <span class="content">
       ...
       <br>
       Finesses the current pipeline for accurate analysis of species of interest, (*Anabrus simplex*(Mormon cricket), *Schistocerca piceifrons*(Central American Locust), and Eremidium grasshoppers)
       <br>
  </span>
</span>
